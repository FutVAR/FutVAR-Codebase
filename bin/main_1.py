...
def resolve_goalkeepers_team_id_vonoroi(players: sv.Detections,goalkeepers: sv.Detections) -> np.ndarray:
    goalkeepers_xy = goalkeepers.get_anchors_coordinates(sv.Position.BOTTOM_CENTER)
    players_xy = players.get_anchors_coordinates(sv.Position.BOTTOM_CENTER)
...
def run_vonoroi(source_video_path: str, device: str) -> Iterator[np.ndarray]:
    ...
    for frame in frame_generator:
        ...
        goalkeepers_detections.class_id = resolve_goalkeepers_team_id_vonoroi(players_detections, goalkeepers_detections)
...
def main(source_video_path: str, target_video_path: str, device: str, mode: Mode) -> None:
    ...
    elif mode == Mode.VONOROI:
        frame_generator = run_vonoroi(
            source_video_path=source_video_path, device=device)
